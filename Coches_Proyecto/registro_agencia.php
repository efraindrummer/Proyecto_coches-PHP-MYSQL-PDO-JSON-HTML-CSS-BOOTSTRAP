...
<center>
	...
	<div class="form-group">
		...
		<input type="text" placeholder="Introduce el nombre de la agencia..." name="nombre_agencia" class="form-control" id="nombre_agencia" size="43px">
	</div>
</center>
	<center>
		<br><br>
		<input type="submit" value="ENVIAR" class="btn btn-primary" name="btn1">
		<input type="submit" value="CONSULTA" class="btn btn-primary" name="btn2">
		<input type="submit" value="ACTUALIZAR" class="btn btn-primary" name="btn3">
		<input type="submit" value="ELIMINAR" class="btn btn-danger" name="btn4">
		<input type="button" value="SIGUIENTE" class="btn btn-warning" 	onclick="location.href='registro_reserva.php' "name="btn5"/> 
		<input type="button" value="CONSULTA GENERAL DE LA TABLA" class="btn btn-info" 	onclick="location.href='consulta_tabla_agencia.php' "name="agencia"/> 
	</center>	
</form>
