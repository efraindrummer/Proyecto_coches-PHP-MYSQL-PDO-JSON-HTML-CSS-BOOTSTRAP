        ...
        <body>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8"><font color="#000"><center><strong><h1>RESERVA DE COCHES</h1></strong><h3>Php+Css+Html5+Bootstrap+MySQL</h3></center></font></div>
                    <div class="col-md-2"></div>
                </div>
                <hr>
    <h3>    
                    ...
                    <div class="col-md-4">
                        <div class="well"> <!--hace un sombreado a la columna-->
                            <center>
                                ...
                                <img src="1234.jpg" class="img-circle" width="199" height="199">
                                
                                <br><br><br>
                                
                                <form class="form-inline" method="POST" action="registro_clientes.php" name="login">
