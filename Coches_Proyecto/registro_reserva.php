...
<center>
	<div class="form-group">
		...
		<input type="text" placeholder="Introduce el numero de reserva..." name="id_reserva" class="form-control" id="id_reserva" size="30px">
	</div>
	<br>
	<div class="form-group">
      	<label for="fecha_inicio">FECHA DE INICIO:</label>
		<input type="date" placeholder="introduce: 2000-01-01..." name="fecha_inicio" class="form-control" id="fecha_inicio" size="35px">
	</div>
	<br>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<input type="text" placeholder="Introduce la cantidad de litros..." name="litros" class="form-control" id="litros" size="44px">
	</div>
	<br>
	<div class="form-group">
      	<label for="precio">PRECIO:</label>
		<input type="text" placeholder="Introduce el precio: 1234..." name="precio" class="form-control" id="precio" size="45px">
	</div>
	<br>
	<div class="form-group">
      	<label for="cliente_id_cliente">ID CLIENTE:</label>
		<input type="text" placeholder="Introduce el numero de cliente..." name="cliente_id_cliente" class="form-control" id="cliente_id_cliente" size="41px">
	</div>
	<br>
	<div class="form-group">
      	<label for="agencia_id_agencia1">ID AGENCIA:</label>
		<input type="text" placeholder="Introduce el numero de agencia..." name="agencia_id_agencia1" class="form-control" id="agencia_id_agencia1" size="41px">
	</div>
	...
	<center>
		...
		<input type="button" value="SIGUIENTE" class="btn btn-warning" 	onclick="location.href='registro_garage.php' "name="btn2"/> 
		<input type="button" value="CONSULTA GENERAL DE LA TABLA" class="btn btn-info" 	onclick="location.href='consulta_tabla_reserva.php' "name="btn2"/>
	</center>	
</form>
