	...
	<div class="row">
	  ...
	  <br><br>
		...
		<div class="form-group">
			...
			<input type="text" placeholder="Introduce el nombre del garage..." name="nombre_garage" class="form-control" id="nombre_garage" size="39px">
		</div>

		<div class="form-group">
      		<label for="coche_matricula">MATRICULA DEL COCHE:</label>
			<input type="text"placeholder="Introduce la matricula del coche..." name="coche_matricula" class="form-control" id="coche_matricula" size="38px">
		</div>
  			...
  			<center>
				...
				<input type="submit" value="ACTUALIZAR" class="btn btn-primary" name="modificar">
				<input type="submit" value="ELIMINAR" class="btn btn-danger" name="eliminar">
				<input type="button" value="SIGUIENTE" class="btn btn-warning" 	onclick="location.href='registro_coche.php' "name="btn"/> 
				<input type="button" value="CONSULTA GENERAL DE LA TABLA" class="btn btn-success" 	onclick="location.href='consulta_tabla_garage.php' "name="garage"/>
  		</center>	
  	</form>
