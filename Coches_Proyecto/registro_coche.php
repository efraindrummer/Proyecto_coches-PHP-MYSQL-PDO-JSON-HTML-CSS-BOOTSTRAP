  	...
  	<form method="POST" action="registro_coche.php" class="form-inline">
  		<center>
			<br><br>
  			...
  			<div class="form-group">
				...
				<input type="text" placeholder="Introduce la marca..." name="marca" class="form-control" id="marca" size="47px">
  			</div>

  			<div class="form-group">
  				<label for="modelo">MODELO:</label>
				<input type="text" placeholder="introduce el modelo..." name="modelo" class="form-control" id="modelo" size="46px">
  			</div>

  			<div class="form-group">
  				<label for="GARAGE_id_garage">NUMERO DE GARAGE:</label>
				<input type="text" placeholder="introduce el id del garage ya ingresado antes..." name="GARAGE_id_garage" class="form-control" id="GARAGE_id_garage" size="33px">
  			</div>
  		...
  		<center>
			...
			<input type="submit" value="ELIMINAR" class="btn btn-danger" name="eliminar">
      		<input type="button" value="SIGUIENTE" class="btn btn-warning"  onclick="location.href='registro_involucra.php' "name="btn2"/> 
			<input type="button" value="CONSULTA GENERAL DE LA TABLA" class="btn btn-info"  onclick="location.href='consulta_tabla_coche.php' "name="coche"/>
		</center>		
  	</form>
