  	...
  	<center>
		...
		<div class="form-group">
  		...
  		<center>
			...
			<input type="submit" value="CONSULTA" class="btn btn-primary" name="btn_consultar">
			<input type="submit" value="ACTUALIZAR" class="btn btn-primary" name="btn_actualizar">
			<input type="submit" value="ELIMINAR" class="btn btn-danger" name="btn_eliminar">
			<input type="button" value="SIGUIENTE" class="btn btn-warning" onclick="location.href='registro_agencia.php' "name="btn3"/> 
			<input type="button" value="CONSULTA GENERAL DE LA TABLA CLIENTES" class="btn btn-info" onclick="location.href='consulta_tabla_cliente.php' "name="tabla"/> 
  		</center>
