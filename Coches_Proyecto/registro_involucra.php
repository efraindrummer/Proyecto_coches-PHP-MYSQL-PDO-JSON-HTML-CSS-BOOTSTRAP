  	...
  	<form method="POST" action="registro_involucra.php" class="form-inline">
  		<center>
			<br><br>
  			...
  			<div class="form-group">
				...
				<input type="text" placeholder="Introduce el id matricula antes ingresado..." name="id_matricula" class="form-control" id="id_matricula" size="37px">
  			</div>

  			<div class="form-group">
  				<label for="PrecioAlquiler">PRECIO ALQUILER:</label>
				<input type="text" placeholder="Introduce el precio del alquiler..." name="PrecioAlquiler" class="form-control" id="PrecioAlquiler" size="44px">
  			</div>
  		...
  		<center>
			...
			<input type="submit" value="CONSULTAR" class="btn btn-primary" name="consultar">
      		<input type="button" value="SIGUIENTE" class="btn btn-warning"  onclick="location.href='consultas.php' "name="btn2"/>
			<input type="button" value="CONSULTA GENERAL DE LA TABALA" class="btn btn-success" onclick="location.href='consulta_tabla_involucra.php' "name="btn2"/>			
		</center>		
  	</form>
